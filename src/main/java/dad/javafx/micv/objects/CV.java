...
public class CV {
	...
	private ObjectProperty<Titulo> titulo = new SimpleObjectProperty<Titulo>();
	private ObjectProperty<Experiencia> experiencia = new SimpleObjectProperty<Experiencia>();
	private ObjectProperty<Conocimiento> conocimiento = new SimpleObjectProperty<Conocimiento>();
